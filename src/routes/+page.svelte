		...
		{#if initialAnimate}
			...
			<div class="flex flex-row gap-2 justify-center grow-0">
				<div
					...
					id="button1"
					class=" hover:scale-110 delay-75 transition p-0.5 active:shadow-md active:shadow-emerald-500"
				>
					<!-- {#if movie}
					...
					{:else} -->
						<button
							class="font-bold rounded-full bg-cyan-900 text-white px-4 py-2 cursor-pointer"
							on:click={() => {
				...
				>
					<button
						class="font-bold rounded-full bg-lime-900 text-white px-4 py-2 cursor-pointer"
						on:click={() => {
				...
				>
					<button
						class="font-bold rounded-full bg-orange-900 text-white px-4 py-2 cursor-pointer  transition delay-75"
						on:click={() => {
				...
				>
					<button
						class="font-bold rounded-full bg-emerald-900 text-white px-4 py-2 cursor-pointer "
						on:click={() => {
